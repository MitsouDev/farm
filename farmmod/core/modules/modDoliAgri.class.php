 ...
 *
 *  \file       htdocs/mymodule/core/modules/modDoliAgri.class.php
 *  \ingroup    mymodule
 ...
 */
class modDoliAgri extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->editor_name = 'La ferme de Mitsou';
		$this->editor_url = 'http://www.lafermedemitsou.fr/';
		...
		$this->module_parts = array(
									...
									'css' => array('/doliagri/css/doliagri.css.php'),	// Set this to relative path of css file if module has its own css file
	 								'js' => array('/doliagri/js/doliagri.js.php'),          // Set this to relative path of js file if module must load a js on all pages
		...
		$this->config_page_url = array("setup.php@doliagri");
		...
		$this->langfiles = array("doliagri@doliagri");
		...
		// );
		$this->const = array(
			1=>array('DOLIAGRI_MYCONSTANT', 'moduleagri', 'actif', 'This is a constant to add', 1, 'allentities', 1)
		);
		...
		if (! isset($conf->doliagri) || ! isset($conf->doliagri->enabled))
        {
        	$conf->doliagri=new stdClass();
        	$conf->doliagri->enabled=0;
        }
        ...
        */
        ...
        $this->boxes = array(
        	0=>array('file'=>'doliagriwidget1.php@doliagri','note'=>'Widget provided by DoliAgri','enabledbydefaulton'=>'Home'),
		...
		$this->rights[$r][1] = 'Read objects of DoliAgri Module';	// Permission label
		...
		$r++;
		$this->rights[$r][0] = $this->numero + $r;	// Permission id (must not be already used)
		$this->rights[$r][1] = 'Create/Update objects of DoliAgri Module';	// Permission label
		$this->rights[$r][3] = 1; 					// Permission by default for new user (0/1)
		...
		$r++;
		$this->rights[$r][0] = $this->numero + $r;	// Permission id (must not be already used)
		$this->rights[$r][1] = 'Delete objects of DoliAgri Module';	// Permission label
		$this->rights[$r][3] = 1; 					// Permission by default for new user (0/1)
		...
		$this->menu[$r++]=array('fk_menu'=>'',			                // '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
								...
								'mainmenu'=>'doliagri',
								'leftmenu'=>'',
								'url'=>'/doliagri/doliagriindex.php',
								'langs'=>'doliagri@doliagri',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
								'position'=>1000+$r,
								'enabled'=>'$conf->doliagri->enabled',	// Define condition to show or hide menu entry. Use '$conf->mymodule->enabled' if entry must be visible if module is enabled.
	...
	public function init($options='')
	{
		...
		$this->_load_tables('/doliagri/sql/');
