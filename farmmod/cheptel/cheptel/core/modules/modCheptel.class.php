...
class modMyModule extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->numero = 590000;		// TODO Go on page http://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'cheptel';

		// Family can be 'crm','financial','hr','projects','products','ecm','technic','interface','other'
		// It is used to group modules by family in module setup page
		$this->family = "other";
		// Module position in the family
		$this->module_position = 590;
		...
		$this->description = "Module de gestion des cheptels";
		$this->descriptionlong = "Permet la gestion d'un cheptel dans une exploitation";
		$this->editor_name = 'SCEA LA FERME DE MITSOU';
		$this->editor_url = 'https://www.lafermedemistu.fr';
